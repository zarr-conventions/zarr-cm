...
def workflow_create() -> dict[str, Any]:
    ...
    attrs = proj.create_convention_attrs(code="EPSG:4326")
...
def workflow_read_unknown() -> None:
    ...
    old_doc = proj.create_convention_attrs(code="EPSG:4326", revision="r2")
...
def workflow_migrate() -> None:
    ...
    migrated = proj.create_convention_attrs(code=old["proj:code"])
    ...
    relaxed = proj.create_convention_attrs(code="epsg:4326")
